...
DataboxAlwaysSpawn | false | By default the game doesn't spawn databoxes if the player already knows the technology it gives; with this tweak databoxes are always spawned.
